...
import com.auf.breweryapplication.ListBreweries
...
class DataAdapters(private var brewlist: ArrayList<BrewingInfoData>, listBreweries: ListBreweries) : RecyclerView.Adapter<DataAdapters.BrewDataViewHolder>(), Serializable {
